    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 gap-6 pt-5 xl:grid-cols-2">
                ...
                <PanelCodeHighlight
                    title="Basic"
                    codeHighlight={`<div className="prose bg-[#f1f2f3] px-4 py-9 sm:px-8 sm:py-16 rounded-sm max-w-full dark:bg-[#1b2e4b] dark:text-white-light w-full mb-5">
    ...
    <p className="lead">
        <button type="button" className="btn btn-dark">
            Learn more
                ...
                >
                    <div className="prose mb-5 w-full max-w-full rounded-sm bg-[#f1f2f3] px-4 py-9 dark:bg-[#1b2e4b] dark:text-white-light sm:px-8 sm:py-16">
