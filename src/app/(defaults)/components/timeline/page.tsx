            ...
            <div className="mt-4 sm:mt-7 mb-16">
                ...
                >
                    <div className="mb-5">
                        ...
                        <div className="sm:flex">
                            <div className="relative z-2 mx-auto mb-5 before:absolute before:-bottom-[15px] before:left-1/2 before:top-12 before:-z-1 before:hidden before:h-auto before:w-0 before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] dark:before:border-[#191e3a] sm:mb-0 sm:before:block sm:ltr:mr-8 sm:rtl:ml-8">
                            ...
                            <div className="flex-1">
                                <h4 className="text-center text-xl font-bold text-primary sm:ltr:text-left sm:rtl:text-right">Laurie Fox</h4>
                                <p className="text-center sm:ltr:text-left sm:rtl:text-right">5 sec</p>
                        ...
                        <div className="sm:flex">
                            ...
                            <div className="flex-1">
                                <h4 className="text-center text-xl font-bold text-primary sm:ltr:text-left sm:rtl:text-right">Justin Cross</h4>
                                <p className="text-center sm:ltr:text-left sm:rtl:text-right">45 min</p>
                                <div className="mb-16 mt-4 sm:mt-7">
                    ...
                    <div className="mb-5 inline-block w-full">
                        <ul className="relative mx-auto table max-w-[900px] py-12 before:absolute before:bottom-0 before:left-1/2 before:top-0 before:-ml-[1.5px] before:w-[3px] before:bg-[#ebedf2] dark:before:bg-[#191e3a]">
                            ...
                            <li className="relative mb-12 before:clear-both before:table after:clear-both after:table">
                                ...
                                <div className="relative mx-auto w-full max-w-[320px] rounded-md border border-[#ebedf2] bg-white shadow-[0_20px_20px_rgba(126,142,177,0.12)] before:absolute before:top-10 before:hidden before:h-[3px] before:w-[37px] before:rounded-full before:bg-[#ebedf2] ltr:before:-left-[37px] rtl:before:-right-[37px] dark:border-[#191e3a] dark:bg-[#191e3a] dark:before:bg-[#191e3a]  sm:w-[46%] sm:max-w-full sm:before:block sm:ltr:float-right sm:rtl:float-left">
                                    <div>
                                        <img src="/assets/images/menu-heade.jpg" alt="timeline" className="w-full rounded-t-md" />
                                    </div>
                                    <div className="p-5">
                ...
                >
                    <div className="mb-5">
                        <div className="mx-auto max-w-[900px]">
                            <div className="flex">
                                <p className="min-w-[58px] max-w-[100px] py-2.5 text-base font-semibold text-dark dark:text-white-light">10:00</p>
                                ...
                                <div className="self-center p-2.5 ltr:ml-2.5 rtl:ml-2.5 ltr:rtl:mr-2.5">
                                    <p className="text-[13px] font-semibold text-dark dark:text-white-light">Updated Server Logs</p>
                                    <p className="min-w-[100px] max-w-[100px] self-center text-xs font-bold text-white-dark">25 mins ago</p>
                                </div>
                            </div>
                            <div className="flex">
                                <p className="min-w-[58px] max-w-[100px] py-2.5 text-base font-semibold text-dark dark:text-white-light">12:45</p>
                                <div className="relative before:absolute before:left-1/2 before:top-[15px] before:h-2.5 before:w-2.5 before:-translate-x-1/2 before:rounded-full before:border-2 before:border-secondary after:absolute after:-bottom-[15px] after:left-1/2 after:top-[25px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-secondary"></div>
                                <div className="self-center p-2.5 ltr:ml-2.5 rtl:ml-2.5 ltr:rtl:mr-2.5">
                                    <p className="text-[13px] font-semibold text-dark dark:text-white-light">Backup Files EOD</p>
                                    <p className="min-w-[100px] max-w-[100px] self-center text-xs font-bold text-white-dark">2 hrs ago</p>
                                </div>
                            </div>
                            <div className="flex">
                                <p className="min-w-[58px] max-w-[100px] py-2.5 text-base font-semibold text-dark dark:text-white-light">14:00</p>
                                <div className="relative before:absolute before:left-1/2 before:top-[15px] before:h-2.5 before:w-2.5 before:-translate-x-1/2 before:rounded-full before:border-2 before:border-success after:absolute after:-bottom-[15px] after:left-1/2 after:top-[25px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-success"></div>
                                <div className="self-center p-2.5 ltr:ml-2.5 rtl:ml-2.5 ltr:rtl:mr-2.5">
                                    <p className="text-[13px] font-semibold text-dark dark:text-white-light">Send Mail to HR and Admin</p>
                                    <p className="min-w-[100px] max-w-[100px] self-center text-xs font-bold text-white-dark">4 hrs ago</p>
                                </div>
                            </div>
                            <div className="flex">
                                <p className="min-w-[58px] max-w-[100px] py-2.5 text-base font-semibold text-dark dark:text-white-light">16:00</p>
                                <div className="relative before:absolute before:left-1/2 before:top-[15px] before:h-2.5 before:w-2.5 before:-translate-x-1/2 before:rounded-full before:border-2 before:border-danger after:absolute after:-bottom-[15px] after:left-1/2 after:top-[25px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-danger"></div>
                                <div className="self-center p-2.5 ltr:ml-2.5 rtl:ml-2.5 ltr:rtl:mr-2.5">
                                    <p className="text-[13px] font-semibold text-dark dark:text-white-light">Conference call with Marketing Manager.</p>
                                    <p className="min-w-[100px] max-w-[100px] self-center text-xs font-bold text-white-dark">6 hrs ago</p>
                                </div>
                            </div>
                            <div className="flex">
                                <p className="min-w-[58px] max-w-[100px] py-2.5 text-base font-semibold text-dark dark:text-white-light">17:00</p>
                                <div className="relative before:absolute before:left-1/2 before:top-[15px] before:h-2.5 before:w-2.5 before:-translate-x-1/2 before:rounded-full before:border-2 before:border-warning after:absolute after:-bottom-[15px] after:left-1/2 after:top-[25px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-warning"></div>
                                <div className="self-center p-2.5 ltr:ml-2.5 rtl:ml-2.5 ltr:rtl:mr-2.5">
                                    <p className="text-[13px] font-semibold text-dark dark:text-white-light">
                                        Collected documents from <button type="button">Sara</button>
                                    </p>
                            ...
                            <div className="flex">
                                ...
                                <div className="self-center p-2.5 ltr:ml-2.5 rtl:ml-2.5 ltr:rtl:mr-2.5">
                                    <p className="text-[13px] font-semibold text-dark dark:text-white-light">Server rebooted successfully</p>
    ...
    <div className="max-w-[900px] mx-auto text-center sm:ltr:text-left sm:rtl:text-right space-y-3 sm:space-y-0">
        ...
        <div className="sm:flex items-center">
            ...
            <p className="text-dark dark:text-white-light font-semibold text-[13px] p-2.5">PDF file Download</p>
                ...
                >
                    <div className="mb-5">
                        <div className="mx-auto max-w-[900px] space-y-3 text-center sm:space-y-0 sm:ltr:text-left sm:rtl:text-right">
                            <div className="items-center sm:flex">
                                <p className="p-2.5 text-base font-semibold text-dark dark:text-white-light">09:00</p>
                                ...
                                <p className="p-2.5 text-[13px] font-semibold text-dark dark:text-white-light">Conference call with Marketing Manager.</p>
                            </div>
                            <div className="items-center sm:flex">
                                <p className="p-2.5 text-base font-semibold text-dark dark:text-white-light">10:00</p>
                                <div className="relative p-2.5 after:absolute after:-bottom-[15px] after:left-1/2 after:top-[25px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20">
                                ...
                                <p className="p-2.5 text-[13px] font-semibold text-dark dark:text-white-light">Server rebooted successfully</p>
                            </div>
                            <div className="items-center sm:flex">
                                <p className="p-2.5 text-base font-semibold text-dark dark:text-white-light">11:00</p>
                                <div className="relative p-2.5 after:absolute after:-bottom-[15px] after:left-1/2 after:top-[25px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20">
                                ...
                                <p className="p-2.5 text-[13px] font-semibold text-dark dark:text-white-light">Backup Files EOD</p>
                            </div>
                            <div className="items-center sm:flex">
                                <p className="p-2.5 text-base font-semibold text-dark dark:text-white-light">12:00</p>
                                <div className="relative p-2.5 after:absolute after:-bottom-[15px] after:left-1/2 after:top-[25px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20">
                                ...
                                <p className="p-2.5 text-[13px] font-semibold text-dark dark:text-white-light">Collected documents from Sara</p>
                            </div>
                            <div className="items-center sm:flex">
                                <p className="p-2.5 text-base font-semibold text-dark dark:text-white-light">01:00</p>
                                ...
                                <p className="p-2.5 text-[13px] font-semibold text-dark dark:text-white-light">PDF file Download</p>
                            </div>
                        </div>
                    </div>
                </PanelCodeHighlight>
