...
const ElementsAlertsWithIcon = () => {
    return (
        <PanelCodeHighlight
            ...
            codeHighlight={`<div className="relative flex items-center border p-3.5 rounded-sm text-success bg-success-light border-success ltr:border-l-64 rtl:border-r-64 dark:bg-success-dark-light">
    ...
    <button type="button" className="ltr:ml-auto rtl:mr-auto hover:opacity-80">
        ...
        >
            <div className="mb-5 grid gap-5 lg:grid-cols-2">
                <div className="relative flex items-center rounded-sm border border-success bg-success-light p-3.5 text-success ltr:border-l-64 rtl:border-r-64 dark:bg-success-dark-light">
                ...
                <div className="relative flex items-center rounded-sm border border-dark bg-dark-light p-3.5 text-dark ltr:border-r-64 rtl:border-l-64 dark:border-white-light/20 dark:bg-dark-dark-light dark:text-white-light">
