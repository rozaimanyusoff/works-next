...
const ElementsAlertsArrowed = () => {
    return (
        <PanelCodeHighlight
            ...
            codeHighlight={`<div className="relative flex items-center border p-3.5 rounded-sm before:absolute before:top-1/2 ltr:before:left-0 rtl:before:right-0 rtl:before:rotate-180 before:-mt-2 before:border-l-8 before:border-t-8 before:border-b-8 before:border-t-transparent before:border-b-transparent before:border-l-inherit text-primary bg-primary-light border-primary! ltr:border-l-64 rtl:border-r-64 dark:bg-primary-dark-light">
    ...
    <button type="button" className="ltr:ml-auto rtl:mr-auto hover:opacity-80">
        ...
        >
            <div className="mb-5 grid gap-5 lg:grid-cols-2">
                <div className="relative flex items-center rounded-sm border border-primary! bg-primary-light p-3.5 text-primary before:absolute before:top-1/2 before:-mt-2 before:border-b-8 before:border-l-8 before:border-t-8 before:border-b-transparent before:border-l-inherit before:border-t-transparent ltr:border-l-64 ltr:before:left-0 rtl:border-r-64 rtl:before:right-0 rtl:before:rotate-180 dark:bg-primary-dark-light">
                ...
                <div className="relative flex items-center rounded-sm border border-danger bg-danger-light p-3.5 text-danger before:absolute before:top-1/2 before:-mt-2 before:inline-block before:border-b-8 before:border-r-8 before:border-t-8 before:border-b-transparent before:border-r-inherit before:border-t-transparent ltr:border-r-64 ltr:before:right-0 rtl:border-l-64 rtl:before:left-0 rtl:before:rotate-180 dark:bg-danger-dark-light">
