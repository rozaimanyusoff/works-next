            ...
            <div className="mb-5">
                <div className="mx-auto max-w-[320px] dark:text-white-dark md:max-w-[1140px]">
                    <div className="mt-5 flex justify-center space-x-4 text-center text-base font-semibold rtl:space-x-reverse md:mt-10">
                        ...
                        <label className="relative h-6 w-12">
                            <input
                                ...
                                onChange={() => setYearlyPrice(!yearlyPrice)}
                            />
                            <span className="outline_checkbox bg-icon block h-full rounded-full border-2 border-[#ebedf2] before:absolute before:bottom-1 before:h-4 before:w-4 before:rounded-full before:bg-[#ebedf2] before:bg-[url(/assets/images/close.svg)] before:bg-center before:bg-no-repeat before:transition-all before:duration-300 peer-checked:border-primary peer-checked:before:bg-primary peer-checked:before:bg-[url(/assets/images/checked.svg)] ltr:before:left-1 peer-checked:ltr:before:left-7 rtl:before:right-1 peer-checked:rtl:before:right-7 dark:border-white-dark dark:before:bg-white-dark"></span>
                        </label>
                        <span className={`relative ${yearlyPrice ? 'text-primary' : ' text-white-dark'}  `}>
                            Yearly
                    ...
                    <div className="mt-5 space-y-4 text-white-dark md:mt-16 md:flex md:space-y-0">
                        <div className="rounded-md border border-white-light p-4 transition-all duration-300 hover:shadow-[0_0_15px_1px_rgba(113,106,202,0.20)] dark:border-[#1b2e4b] md:ltr:rounded-r-none md:ltr:border-r-0 md:rtl:rounded-l-none md:rtl:border-l-0 lg:p-9">
                            <h3 className="mb-5 text-xl font-semibold text-black dark:text-white-light">Cloud Hosting</h3>
                            <p>cPanel/WHM included. Intel Xeon E3 with guaranteed 2GB RAM.</p>
                            <div className="my-7 p-2.5 text-center text-lg">
                                <strong className="text-xl text-dark dark:text-white-light lg:text-3xl">$25</strong> / monthly
                            </div>
                            <div className="mb-6">
                        ...
                        <div className="rounded-md border border-white-light p-4 transition-all duration-300 hover:shadow-[0_0_15px_1px_rgba(113,106,202,0.20)] dark:border-[#1b2e4b] md:ltr:rounded-l-none md:ltr:border-l-0 md:rtl:rounded-r-none md:rtl:border-r-0 lg:p-9">
                            <h3 className="mb-5 text-xl font-semibold text-black dark:text-white-light">Business Hosting</h3>
                            <p>cPanel/WHM included. Intel Xeon E5 with guaranteed 8GB RAM.</p>
                            <div className="my-7 p-2.5 text-center text-lg">
                                <strong className="text-xl text-dark dark:text-white-light lg:text-3xl">$115</strong> / monthly
                            </div>
                            <div className="mb-6">
